...
void gpio_init()
{
    ...
    GPIO->P[0].MODEL  = GPIO_P_MODEL_MODE0_DISABLED     // BIAS_REG_TEMP
                      | GPIO_P_MODEL_MODE1_DISABLED     // VBIAS1_VSENSE
                      | GPIO_P_MODEL_MODE2_DISABLED     // VBIAS2_VSENSE
    ...
    GPIO->P[0].DOUT   = 0;
    GPIO->P[0].OVTDIS = BIT(0) | BIT(1) | BIT(2);
    ...
    GPIO->P[2].MODEL  = GPIO_P_MODEL_MODE0_DISABLED         // NU
                      | GPIO_P_MODEL_MODE1_PUSHPULL         // LED
                      | GPIO_P_MODEL_MODE2_DISABLED         // NC
                      | GPIO_P_MODEL_MODE3_DISABLED         // NC
                      | GPIO_P_MODEL_MODE4_DISABLED         // NC
                      | GPIO_P_MODEL_MODE5_DISABLED         // NC
    ...
    GPIO->P[2].MODEH  = GPIO_P_MODEH_MODE8_DISABLED         // NC
                      ...
                      | GPIO_P_MODEH_MODE14_PUSHPULL        // nREF_SYNTH_OE
                      | GPIO_P_MODEH_MODE15_DISABLED;       // NU
    GPIO->P[2].DOUT   = BIT(14);
    GPIO->P[2].OVTDIS = 0;
    ...
    GPIO->P[4].MODEH  = GPIO_P_MODEH_MODE8_DISABLED                 // NC
                      | GPIO_P_MODEH_MODE9_DISABLED                 // NC
                      | GPIO_P_MODEH_MODE10_INPUTPULLFILTER         // VBIAS1_PG
                      | GPIO_P_MODEH_MODE11_INPUTPULLFILTER         // VBIAS2_PG
                      | GPIO_P_MODEH_MODE12_PUSHPULL                // VBIAS1_EN
                      | GPIO_P_MODEH_MODE13_PUSHPULL                // VBIAS2_EN
                      | GPIO_P_MODEH_MODE14_DISABLED                // NC
                      | GPIO_P_MODEH_MODE15_DISABLED;               // NC
    GPIO->P[4].DOUT   = BIT(10) | BIT(11);
    GPIO->P[4].OVTDIS = 0;
