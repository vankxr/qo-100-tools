...
static void adf4351_write_register(uint8_t ubRegister, uint32_t ulValue)
{
    ...
    ATOMIC_BLOCK(ATOMIC_RESTORESTATE)
    {
        ...
        usart0_spi_write_byte((ulValue >> 24) & 0xFF, 0);
        usart0_spi_write_byte((ulValue >> 16) & 0xFF, 0);
        usart0_spi_write_byte((ulValue >> 8) & 0xFF, 0);
        usart0_spi_write_byte((((ulValue >> 0) & 0xF8) | (ubRegister & 0x07)), 1);
...
uint8_t adf4351_init()
{
    ...
    adf4351_write_register(2, ADF4351_R2_NOISE_MODE_LOW_NOISE | ADF4351_R2_MUXOUT_DIG_LOCK | ADF4351_R2_REF_DOUBLE_DISABLED | ADF4351_R2_REF_DIV2_ENABLED | (1 << 14) | ADF4351_R2_DBF_R4_DISABLED | (0 << 9) | ADF4351_R2_LDF_FRAC | ADF4351_R2_LDP_6_NS | ADF4351_R2_PD_POSITIVE | ADF4351_R2_POWER_UP | ADF4351_R2_CP_TRISTATE_DISABLED | ADF4351_R2_CNT_RESET_DISABLED);
