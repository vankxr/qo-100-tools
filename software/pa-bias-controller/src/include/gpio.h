...
#define TEC1_DISABE()       PERI_REG_BIT_CLEAR(&(GPIO->P[2].DOUT)) = BIT(1)
#define TEC2_ENABLE()       PERI_REG_BIT_SET(&(GPIO->P[1].DOUT)) = BIT(8)
#define TEC2_DISABE()       PERI_REG_BIT_CLEAR(&(GPIO->P[1].DOUT)) = BIT(8)
#define TEC3_ENABLE()       PERI_REG_BIT_SET(&(GPIO->P[2].DOUT)) = BIT(0)
#define TEC3_DISABE()       PERI_REG_BIT_CLEAR(&(GPIO->P[2].DOUT)) = BIT(0)
#define TEC4_ENABLE()       PERI_REG_BIT_SET(&(GPIO->P[1].DOUT)) = BIT(7)
#define TEC4_DISABE()       PERI_REG_BIT_CLEAR(&(GPIO->P[1].DOUT)) = BIT(7)
