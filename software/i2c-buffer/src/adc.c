...
float adc_get_vbias1()
{
    ...
    ADC0->SINGLECTRL = ADC_SINGLECTRL_AT_256CYCLES | ADC_SINGLECTRL_NEGSEL_VSS | ADC_VBIAS1_CHAN | ADC_SINGLECTRL_REF_5V | ADC_SINGLECTRL_RES_OVS;
    ADC0->SINGLECTRLX = ADC_SINGLECTRLX_FIFOOFACT_OVERWRITE | (0 << _ADC_SINGLECTRLX_DVL_SHIFT);
    ADC0->CAL &= ~(_ADC_CAL_SINGLEGAIN_MASK | _ADC_CAL_SINGLEOFFSET_MASK | _ADC_CAL_SINGLEOFFSETINV_MASK);
    ADC0->CAL |= (DEVINFO->ADC0CAL1 & 0x7FFF0000) >> 16; // Calibration for 5V reference
    ADC0->BIASPROG = (ADC0->BIASPROG & (_ADC_BIASPROG_VFAULTCLR_MASK | _ADC_BIASPROG_ADCBIASPROG_MASK)) | ADC_BIASPROG_GPBIASACC_HIGHACC;
    ...
    float fVBias1 = ADC0->SINGLEDATA * 5000.f / 65535.f;
...
float adc_get_vbias2()
{
    ...
    ADC0->SINGLECTRL = ADC_SINGLECTRL_AT_256CYCLES | ADC_SINGLECTRL_NEGSEL_VSS | ADC_VBIAS2_CHAN | ADC_SINGLECTRL_REF_5V | ADC_SINGLECTRL_RES_OVS;
    ADC0->SINGLECTRLX = ADC_SINGLECTRLX_FIFOOFACT_OVERWRITE | (0 << _ADC_SINGLECTRLX_DVL_SHIFT);
    ADC0->CAL &= ~(_ADC_CAL_SINGLEGAIN_MASK | _ADC_CAL_SINGLEOFFSET_MASK | _ADC_CAL_SINGLEOFFSETINV_MASK);
    ADC0->CAL |= (DEVINFO->ADC0CAL1 & 0x7FFF0000) >> 16; // Calibration for 5V reference
    ADC0->BIASPROG = (ADC0->BIASPROG & (_ADC_BIASPROG_VFAULTCLR_MASK | _ADC_BIASPROG_ADCBIASPROG_MASK)) | ADC_BIASPROG_GPBIASACC_HIGHACC;
    ...
    float fVBias2 = ADC0->SINGLEDATA * 5000.f / 65535.f;
...
float adc_get_vbias3()
{
    ...
    ADC0->SINGLECTRL = ADC_SINGLECTRL_AT_256CYCLES | ADC_SINGLECTRL_NEGSEL_VSS | ADC_VBIAS3_CHAN | ADC_SINGLECTRL_REF_5V | ADC_SINGLECTRL_RES_OVS;
    ADC0->SINGLECTRLX = ADC_SINGLECTRLX_FIFOOFACT_OVERWRITE | (0 << _ADC_SINGLECTRLX_DVL_SHIFT);
    ADC0->CAL &= ~(_ADC_CAL_SINGLEGAIN_MASK | _ADC_CAL_SINGLEOFFSET_MASK | _ADC_CAL_SINGLEOFFSETINV_MASK);
    ADC0->CAL |= (DEVINFO->ADC0CAL1 & 0x7FFF0000) >> 16; // Calibration for 5V reference
    ADC0->BIASPROG = (ADC0->BIASPROG & (_ADC_BIASPROG_VFAULTCLR_MASK | _ADC_BIASPROG_ADCBIASPROG_MASK)) | ADC_BIASPROG_GPBIASACC_HIGHACC;
    ...
    float fVBias3 = ADC0->SINGLEDATA * 5000.f / 65535.f;
...
float adc_get_vbias4()
{
    ...
    ADC0->SINGLECTRL = ADC_SINGLECTRL_AT_256CYCLES | ADC_SINGLECTRL_NEGSEL_VSS | ADC_VBIAS4_CHAN | ADC_SINGLECTRL_REF_5V | ADC_SINGLECTRL_RES_OVS;
    ADC0->SINGLECTRLX = ADC_SINGLECTRLX_FIFOOFACT_OVERWRITE | (0 << _ADC_SINGLECTRLX_DVL_SHIFT);
    ADC0->CAL &= ~(_ADC_CAL_SINGLEGAIN_MASK | _ADC_CAL_SINGLEOFFSET_MASK | _ADC_CAL_SINGLEOFFSETINV_MASK);
    ADC0->CAL |= (DEVINFO->ADC0CAL1 & 0x7FFF0000) >> 16; // Calibration for 5V reference
    ADC0->BIASPROG = (ADC0->BIASPROG & (_ADC_BIASPROG_VFAULTCLR_MASK | _ADC_BIASPROG_ADCBIASPROG_MASK)) | ADC_BIASPROG_GPBIASACC_HIGHACC;
    ...
    float fVBias4 = ADC0->SINGLEDATA * 5000.f / 65535.f;
